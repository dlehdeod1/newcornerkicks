...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', loading, disabled, children, ...props }, ref) => {
    ...
    const variants = {
      primary: 'bg-brand-green hover:bg-[#27AE60] text-white shadow-lg shadow-brand-green/25 focus:ring-brand-green',
      ...
      outline: 'border-2 border-brand-green/50 text-brand-green hover:bg-brand-green/10 focus:ring-brand-green',
    }
