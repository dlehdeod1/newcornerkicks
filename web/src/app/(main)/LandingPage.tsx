    ...
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
            ...
            <div className="flex-1 text-center lg:text-left">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/80 dark:bg-card-elevated backdrop-blur rounded-full text-sm text-slate-600 dark:text-slate-300 mb-8 border border-slate-200 dark:border-slate-700/50 shadow-sm">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {/* 무료 */}
          <div className="bg-white dark:bg-card rounded-2xl p-8 border border-slate-200 dark:border-border shadow-sm">
          ...
          {/* PRO */}
          <div className="relative bg-white dark:bg-card rounded-2xl p-8 border-2 border-primary shadow-lg shadow-primary/10">
...
function FeatureCard({
  ...
  return (
    <div className="bg-white dark:bg-card rounded-2xl p-6 border border-slate-200 dark:border-border shadow-sm hover:shadow-md transition-shadow">
