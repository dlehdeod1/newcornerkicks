                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style: TextStyle(color: Colors.white.withAlpha(102), fontSize: 15),
                            ),
                            if (tab != 'notice') ...[
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(authorName, style: TextStyle(fontSize: 12, color: Colors.white.withAlpha(77))),
          ],
        ),
      ),
    );
          ...
          children: [
            Row(
              children: [
                ...
                const Spacer(),
                if (hasImage) ...[
                  Icon(Icons.image_outlined, size: 14, color: Colors.white.withAlpha(77)),
                  const SizedBox(width: 8),
                ],
                if ((commentCount as int) > 0) ...[
                  Icon(Icons.chat_bubble_outline, size: 13, color: Colors.white.withAlpha(77)),
